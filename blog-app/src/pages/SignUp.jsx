  ...
  return (
    <div className='min-h-screen mt-20'>
      <div className='flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-7'>
        ...
        <span className='px-2 py-1 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-lg text-white'>Tagline's</span>
        Blog
      </Link>
      <p className='text-1xl font-semibold mt-5 '><span className='text-2xl mt-2'>Blog with the best.</span><br/>
  More bloggers and independent creators choose WordPress than any other blogging tool.<br/>
</p>
        </div>
